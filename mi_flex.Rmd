...
<font size = "3"> This idea was initially designed by [Randy Swaty](mailto:rswaty@tnc.org) as an alternative to a PowerPoint presentation. There was interest in building on this idea in the conservation community and I, [Myles Walimaa](mailto:mwalimaa@gmail.com), made some updates with newer data and a few new charts. This can certainly be built upon and these workflows may be used for any area of interest. The State of Michigan is the target area for this dashboard, since it is where both Randy and I have lived for years.  
